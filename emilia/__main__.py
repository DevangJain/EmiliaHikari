    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                ...
                [InlineKeyboardButton(text="My Developer 💻", url="https://t.me/Devaje"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/AllrounderMentor")],
                [InlineKeyboardButton(text="❓ Help", url="https://t.me/{}?start=help".format(context.bot.username)), InlineKeyboardButton(text="💖 Donate", url="https://devaje")]])
